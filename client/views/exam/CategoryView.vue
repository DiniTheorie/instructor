...
import CategoryPreview from '@/components/view/exam/CategoryPreview.vue'
import { routes } from '@/router'
import BackButton from '@/components/layout/HierarchicNav.vue'
import { useI18n } from 'vue-i18n'
import CategoryRemove from '@/components/action/exam/CategoryRemove.vue'
import IdList from '@/components/view/IdList.vue'
import QuestionCreate from '@/components/action/exam/QuestionCreate.vue'
import { supportedLanguages } from '@/components/domain/SupportedLanguage'
import CategoryTranslationEdit from '@/components/action/exam/CategoryTranslationEdit.vue'
